...
for i in range(10):
    ...
    exp_gradient_obj = Exponentiated_Gradient(df_obj.sens_attr_names, constraints = "demographic parity")
    ...
    grid_search_obj = Grid_Search(df_obj.sens_attr_names, constraints = "demographic parity")
    ...
    exp_gradient_obj_2 = Exponentiated_Gradient(df_obj.sens_attr_names, constraints = "equalized odds")
    ...
    grid_search_obj_2 = Grid_Search(df_obj.sens_attr_names, constraints = "equalized odds")
    ...
    w_svm = disp_imp_score_obj_svm.fit(dataset = df_obj, clstype = 'lin-svm')
    ...
    y_pred_eq_opp_2 = eq_of_oppor_obj_2.predict(X_test, S_test)
    ...
    for l in [y_pred_unmitigated, y_pred_mssg, y_pred_samp, y_pred_rewei, y_pred_corr,
              ...
              y_pred_exp_gradient_2, y_pred_zafar, y_pred_zafar_svm, y_pred_eq_opp, y_pred_eq_opp_2]:
...
results_overall.to_csv('experiments/results/Experiment 1/loans-LR-results_overall.csv')
results_by_group.to_csv('experiments/results/Experiment 1/loans-LR-results_by_group.csv')
mean_results_by_group.to_csv('experiments/results/Experiment 1/loans-LR-means_by_group.csv')
mean_results_overall.to_csv('experiments/results/Experiment 1/loans-LR-means_overall.csv')
