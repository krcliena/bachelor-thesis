...
results_overall.to_csv('experiments/results/Experiment 1/adult_race-NB-results_overall.csv')
results_by_group.to_csv('experiments/results/Experiment 1/adult_race-NB-results_by_group.csv')
mean_results_by_group.to_csv('experiments/results/Experiment 1/adult_race-NB-means_by_group.csv')
mean_results_overall.to_csv('experiments/results/Experiment 1/adult_race-NB-means_overall.csv')
