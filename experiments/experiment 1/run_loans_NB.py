...
for i in range(10):
    ...
    mssg_obj = Massaging(X_train, y_train, S_train, sens_group_name = df_obj.sens_group_name, 
                          non_sens_group_name = df_obj.non_sens_group_name, clf=GaussianNB())
    mssg_obj.fit()
    ...
    dispRemover_obj = DisparateImpactRemover(X_train, X_test, y_train, y_test, 
                                              df_obj.sens_attr_names, clf=GaussianNB())
    dispRemover_obj.fit()
    ...
    exp_gradient_obj = Exponentiated_Gradient(df_obj.sens_attr_names, constraints = "demographic parity", estimator=GaussianNB())
    ...
    grid_search_obj = Grid_Search(df_obj.sens_attr_names, constraints = "demographic parity", estimator=GaussianNB())
    ...
    exp_gradient_obj_2 = Exponentiated_Gradient(df_obj.sens_attr_names, constraints = "equalized odds", estimator=GaussianNB())
    ...
    grid_search_obj_2 = Grid_Search(df_obj.sens_attr_names, constraints = "equalized odds", estimator=GaussianNB())
    ...
    w = disp_imp_score_obj.fit(dataset = df_obj, clstype = 'lin-svm')
    ...
    for l in [y_pred_NB, y_pred_mssg, y_pred_samp, y_pred_rewei, y_pred_corr,
              ...
              y_pred_exp_gradient_2, y_pred_zafar, y_pred_eq_opp, y_pred_eq_opp_2]:
...
results_overall.to_csv('experiments/results/Experiment 1/loans-NB-results_overall.csv')
results_by_group.to_csv('experiments/results/Experiment 1/loans-NB-results_by_group.csv')
mean_results_by_group.to_csv('experiments/results/Experiment 1/loans-NB-means_by_group.csv')
mean_results_overall.to_csv('experiments/results/Experiment 1/loans-NB-means_overall.csv')
