...
mean_results_by_group.to_csv('experiments/results/Experiment 1/compas_race-LR-means_by_group.csv')
mean_results_overall.to_csv('experiments/results/Experiment 1/compas_race-LR-means_overall.csv')
