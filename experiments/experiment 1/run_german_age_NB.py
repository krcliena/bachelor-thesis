...
results_overall.to_csv('experiments/results/Experiment 1/german_age-NB-results_overall.csv')
results_by_group.to_csv('experiments/results/Experiment 1/german_age-NB-results_by_group.csv')
mean_results_by_group.to_csv('experiments/results/Experiment 1/german_age-NB-means_by_group.csv')
mean_results_overall.to_csv('experiments/results/Experiment 1/german_age-NB-means_overall.csv')
