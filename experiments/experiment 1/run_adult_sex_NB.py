...
algo_names_dup = ["Unmitigated-NB", "Unmitigated-NB", "Massaging", "Massaging", "Pref. Sampling", "Pref. Sampling", "Reweighing","Reweighing", "Corr. Remover","Corr. Remover",
...
# dp_ratio_baseline = demographic_parity_difference(df_obj.y, df_obj.y, sensitive_features = df_obj.sensitive_attributes["sex"])
# dp_diff_baseline = demographic_parity_ratio(df_obj.y, df_obj.y, sensitive_features = df_obj.sensitive_attributes["sex"])
...
for i in range(10):
    ...
    mssg_obj = Massaging(X_train, y_train, S_train, sens_group_name = df_obj.sens_group_name[0], 
                          non_sens_group_name = df_obj.non_sens_group_name[0], clf=GaussianNB())
    mssg_obj.fit()
    ...
    exp_gradient_obj = Exponentiated_Gradient(df_obj.sens_attr_names[0], constraints = "demographic parity", estimator=GaussianNB())
    ...
    grid_search_obj = Grid_Search(df_obj.sens_attr_names[0], constraints = "demographic parity",estimator=GaussianNB())
    ...
    exp_gradient_obj_2 = Exponentiated_Gradient(df_obj.sens_attr_names[0], constraints = "equalized odds", estimator=GaussianNB())
    ...
    grid_search_obj_2 = Grid_Search(df_obj.sens_attr_names[0], constraints = "equalized odds", estimator=GaussianNB())
    ...
    for l in [y_pred_NB, y_pred_mssg, y_pred_samp, y_pred_rewei, y_pred_corr,
              ...
              y_pred_exp_gradient_2, y_pred_zafar, 
...
results_overall.to_csv('experiments/results/Experiment 1/adult_sex-NB-results_overall.csv')
results_by_group.to_csv('experiments/results/Experiment 1/adult_sex-NB-results_by_group.csv')
mean_results_by_group.to_csv('experiments/results/Experiment 1/adult_sex-NB-means_by_group.csv')
mean_results_overall.to_csv('experiments/results/Experiment 1/adult_sex-NB-means_overall.csv')
# baseline.to_csv('experiments/results/Experiment 1/adult_race-baseline.csv')
