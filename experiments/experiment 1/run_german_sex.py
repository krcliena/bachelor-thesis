...
dp_diff_baseline = demographic_parity_difference(df_obj.y, df_obj.y, sensitive_features = df_obj.sensitive_attributes["sex"])
dp_ratio_baseline = demographic_parity_ratio(df_obj.y, df_obj.y, sensitive_features = df_obj.sensitive_attributes["sex"])
...
baseline.to_csv('experiments/results/Experiment 1/german_sex-baseline.csv')
...
results_overall.to_csv('experiments/results/Experiment 1/german_sex-LR-results_overall.csv')
results_by_group.to_csv('experiments/results/Experiment 1/german_sex-LR-results_by_group.csv')
mean_results_by_group.to_csv('experiments/results/Experiment 1/german_sex-LR-means_by_group.csv')
mean_results_overall.to_csv('experiments/results/Experiment 1/german_sex-LR-means_overall.csv')
