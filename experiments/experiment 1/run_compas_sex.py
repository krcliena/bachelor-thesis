...
for i in range(10):
    ...
    print("Exponentiated EO Gradient", df_obj.data_name, "done.")
    ...
    results_equality_2 = pd.DataFrame({"Equality": y_pred_eq_op_2})
...
results_overall.to_csv('experiments/results/Experiment 1/compas_sex-LR-results_overall.csv')
results_by_group.to_csv('experiments/results/Experiment 1/compas_sex-LR-results_by_group.csv')
mean_results_by_group.to_csv('experiments/results/Experiment 1/compas_sex-LR-means_by_group.csv')
mean_results_overall.to_csv('experiments/results/Experiment 1/compas_sex-LR-means_overall.csv')
