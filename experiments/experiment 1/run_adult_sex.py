...
baseline.to_csv('experiments/results/Experiment 1/adult_sex-baseline.csv')
...
results_overall.to_csv('experiments/results/Experiment 1/adult_sex-LR-results_overall.csv')
results_by_group.to_csv('experiments/results/Experiment 1/adult_sex-LR-results_by_group.csv')
mean_results_by_group.to_csv('experiments/results/Experiment 1/adult_sex-LR-means_by_group.csv')
mean_results_overall.to_csv('experiments/results/Experiment 1/adult_sex-LR-means_overall.csv')
