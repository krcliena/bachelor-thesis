...
for i in range(10):
    ...
    for l in [y_pred_NB, y_pred_mssg, y_pred_samp, y_pred_rewei, y_pred_corr,
              y_pred_dispRemover, y_pred_grid, y_pred_grid_2, y_pred_exp_gradient, y_pred_exp_gradient_2, y_pred_zafar, 
...
results_overall.to_csv('experiments/results/Experiment 1/german_sex-NB-results_overall.csv')
results_by_group.to_csv('experiments/results/Experiment 1/german_sex-NB-results_by_group.csv')
mean_results_by_group.to_csv('experiments/results/Experiment 1/german_sex-NB-means_by_group.csv')
mean_results_overall.to_csv('experiments/results/Experiment 1/german_sex-NB-means_overall.csv')
