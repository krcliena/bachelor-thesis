...
results_overall.to_csv('experiments/results/Experiment 1/adult_race-LR-results_overall.csv')
results_by_group.to_csv('experiments/results/Experiment 1/adult_race-LR-results_by_group.csv')
mean_results_by_group.to_csv('experiments/results/Experiment 1/adult_race-LR-means_by_group.csv')
mean_results_overall.to_csv('experiments/results/Experiment 1/adult_race-LR-means_overall.csv')
