...
for i in range(10):
    ...
    print("Disparate Impact Score LR on", df_obj.data_name, "done.")
...
results_overall.to_csv('experiments/results/Experiment 1/ricci-LR-results_overall.csv')
results_by_group.to_csv('experiments/results/Experiment 1/ricci-LR-results_by_group.csv')
mean_results_by_group.to_csv('experiments/results/Experiment 1/ricci-LR-means_by_group.csv')
mean_results_overall.to_csv('experiments/results/Experiment 1/ricci-LR-means_overall.csv')
