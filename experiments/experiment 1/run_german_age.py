...
dp_diff_baseline = demographic_parity_difference(df_obj.y, df_obj.y, sensitive_features = df_obj.sensitive_attributes["age"])
dp_ratio_baseline = demographic_parity_ratio(df_obj.y, df_obj.y, sensitive_features = df_obj.sensitive_attributes["age"])
...
baseline.to_csv('experiments/results/Experiment 1/german_age-baseline.csv')
...
results_overall.to_csv('experiments/results/Experiment 1/german_age-LR-results_overall.csv')
results_by_group.to_csv('experiments/results/Experiment 1/german_age-LR-results_by_group.csv')
mean_results_by_group.to_csv('experiments/results/Experiment 1/german_age-LR-means_by_group.csv')
mean_results_overall.to_csv('experiments/results/Experiment 1/german_age-LR-means_overall.csv')
