...
for i in range(10):
    ...
    exp_gradient_obj = Exponentiated_Gradient(df_obj.sens_attr_names[0], estimator_exp)
    ...
    grid_search_obj = Grid_Search(df_obj.sens_attr_names[0], estimator_grid)
...
results_overall.to_csv('experiments/results/Experiment 2/adult_sex-in_in-overall.csv')
results_by_group.to_csv('experiments/results/Experiment 2/adult_sex-in_in-by_group.csv')
mean_results_by_group.to_csv('experiments/results/Experiment 2/adult_sex-in_in-mean_by_group.csv')
mean_results_overall.to_csv('experiments/results/Experiment 2/adult_sex-in_in-mean_overall.csv')
