...
results_overall.to_csv('experiments/results/Experiment 3/adult_race-in_in-overall.csv')
results_by_group.to_csv('experiments/results/Experiment 3/adult_race-in_in-by_group.csv')
mean_results_by_group.to_csv('experiments/results/Experiment 3/adult_race-in_in-mean_by_group.csv')
mean_results_overall.to_csv('experiments/results/Experiment 3/adult_race-in_in-mean_overall.csv')
