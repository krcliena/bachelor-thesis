...
for i in range(10):
    ...
    print("Exponentiated Gradient on 2", df_obj.data_name, "done.")
    ...
    print("Grid Search on 2", df_obj.data_name, "done.")
...
mean_results_by_group.to_csv('experiments/results/Experiment 2/german_age-LR-means_by_group-exp2.csv')
mean_results_overall.to_csv('experiments/results/Experiment 2/german_age-LR-means_overall-exp2.csv')
