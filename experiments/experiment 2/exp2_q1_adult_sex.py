...
#results_overall.to_csv('experiments/adult_sex-LR-results_overall.csv')
#results_by_group.to_csv('experiments/adult_sex-LR-results_by_group.csv')
mean_results_by_group.to_csv('experiments/results/Experiment 2/adult_sex-LR-means_by_group-exp2.csv')
mean_results_overall.to_csv('experiments/results/Experiment 2/adult_sex-LR-means_overall-exp2.csv')
