...
for i in range(10):
    X_train, X_test, y_train, y_test, S_train, S_test, S_train_num, S_test_num,_, S_test_oth = df_obj.train_test_split(train_size = 0.7, sensitive = 'race')
...
# results_overall.to_csv('experiments/results/adult_race-LR-results_overall.csv')
# results_by_group.to_csv('experiments/results/adult_race-LR-results_by_group.csv')
#mean_results_by_group.to_csv('experiments/results/Experiment 2/adult_race-zafar-exp2.csv')
mean_results_overall.to_csv('experiments/results/Experiment 2/adult_race-zafar-exp2.csv')
