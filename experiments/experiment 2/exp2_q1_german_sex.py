...
for i in range(10):
    ...
    X_train, X_test, y_train, y_test, S_train, S_test, S_train_num, S_test_num, S_train_oth, S_test_oth = df_obj.train_test_split(train_size = 0.7, sensitive = 'sex')
    ...
    exp_gradient_obj = Exponentiated_Gradient(df_obj.sens_attr_names[0], constraints = "demographic parity")
    ...
    grid_search_obj = Grid_Search(df_obj.sens_attr_names[0], constraints = "demographic parity")
    ...
    exp_gradient_obj_2 = Exponentiated_Gradient(df_obj.sens_attr_names[0], constraints = "equalized odds")
    ...
    grid_search_obj_2 = Grid_Search(df_obj.sens_attr_names[0], constraints = "equalized odds")
    ...
    for l in [y_pred_unmitigated, y_pred_mssg, y_pred_samp, y_pred_rewei, y_pred_corr,
              y_pred_dispRemover, y_pred_grid, y_pred_grid_2, y_pred_exp_gradient, y_pred_exp_gradient_2, 
              y_pred_zafar, y_pred_zafar_svm ,y_pred_eq_opp, y_pred_eq_op_2]:
        demo = demographic_parity_difference(y_test, l, sensitive_features = S_test_oth)
        demo1 = demographic_parity_ratio(y_test, l, sensitive_features= S_test_oth)
        eq = equalized_odds_difference(y_test, l, sensitive_features = S_test_oth)
        eq1 = equalized_odds_ratio(y_test, l, sensitive_features = S_test_oth)
...
results_overall.to_csv('experiments/results/Experiment 2/german_sex-LR-results_overall-exp2.csv')
results_by_group.to_csv('experiments/results/Experiment 2/german_sex-LR-results_by_group-exp2.csv')
mean_results_by_group.to_csv('experiments/results/Experiment 2/german_sex-LR-means_by_group-exp2.csv')
mean_results_overall.to_csv('experiments/results/Experiment 2/german_sex-LR-means_overall-exp2.csv')
