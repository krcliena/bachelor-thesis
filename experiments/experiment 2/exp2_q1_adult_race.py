...
mean_results_by_group.to_csv('experiments/results/Experiment 2/adult_race-LR-means_by_group-exp2.csv')
mean_results_overall.to_csv('experiments/results/Experiment 2/adult_race-LR-means_overall-exp2.csv')
