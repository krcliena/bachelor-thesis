...
#results_overall.to_csv('experiments/results/Experiment 1/compas_race-LR-results_overall.csv')
#results_by_group.to_csv('experiments/results/Experiment 1/compas_race-LR-results_by_group.csv')
#mean_results_by_group.to_csv('experiments/results/Experiment 1/compas_race-LR-means_by_group_exp2.csv')
mean_results_overall.to_csv('experiments/results/Experiment 1/compas_race-zafar-exp2.csv')
