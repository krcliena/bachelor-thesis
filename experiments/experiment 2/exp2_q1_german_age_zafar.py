...
for i in range(10):
    ...
    X_train, X_test, y_train, y_test, S_train, S_test, S_train_num, S_test_num, S_train_oth, S_test_oth = df_obj.train_test_split(train_size = 0.7)
...
#mean_results_by_group.to_csv('experiments/results/Experiment 2/german_age-zafar-exp2.csv')
mean_results_overall.to_csv('experiments/results/Experiment 2/german_age-zafar-exp2.csv')
